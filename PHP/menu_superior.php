...
// ************ traducible ******* //
    ...
    if (S_iniciado() && _F_usuario_cache('nivel') == 'externo') {
        echo '
    <li><a href="#" onclick="return false;" title="' . _('Módulo de mantenimiento') . '">' . _('MYR') . '</a>
    <ul>
    ...
    <!-- <li><a href="' . PROY_URL . 'util.inventariable.html?filtro=material">' . _('Materiales´+ inventario') . '</a> -->
        <li><a href="' . PROY_URL . 'util.mecanico.html?filtro=mecanico">' . _('Mecanico') . '</a>
        <li><a href="' . PROY_URL . 'util.orden.taller.html?filtro=mecanico">' . _('Orden Taller') . '</a>
        <li><a href="' . PROY_URL . 'util.orden.codes.html?filtro=mecanico">' . _('Codigos Taller') . '</a>
        <li><a href="' . PROY_URL . 'util.orden.proveedor.html">' . _('Proveedores') . '</a>
        <li><a href="' . PROY_URL . 'util.mecanico.buscar.html?filtro=mecanico">' . _('')   . '</a>
    </ul>
    </li>
    ...
    <li><a href="<?= PROY_URL ?>contenedores.html" title="Módulo de contenedores">Contenedores</a>
        <ul>
            ...
            <li><a href="<?php echo PROY_URL; ?>control.ot.html" title="Control OT">Control Ordenes de Trabajo</a>
            <li><a href="<?php echo PROY_URL; ?>control.ot.manodeobra.html" title="Control OT">Control Mano de Obra</a>
        </ul>
    </li>
