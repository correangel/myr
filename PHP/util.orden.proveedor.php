<?php
 ...
 //$persona->guardar();
  $count = $proveedor->selectProveedor();
        ...
        <div class="col-lg-11 col-md-11">
            <div class="panel panel-default">
                <div class="panel-heading">   
                    <h3><img src="icon/conversation-1.png" width="60px" /> Catalogo / Lista Proveedores</h3>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <a href='util.orden.proveedor.add.html' id="left" class='btn btn-default'>Agregar</a>
                    </div>
                </div>
    ...
    jQuery(function ($) {
        function createFirstGridData() {
            ...
            for (var i = 0; i < count.length; i++) {
                ...
                data.push({                    
                    Nombre: count[i][1],
                    NombreLegal:  count[i][2],
                    ConsumidorFinal:  count[i][3],
                    CreditoFiscal:  count[i][4],
                    Estado:  estado,
                    Actualizar: "<a href='util.orden.proveedor.buscar.html?ID="+count[i][0]+"'  class='btn btn-default'>Actualizar</a>"                                       
                });
            }
            return data;
        }
        ...
        $("#grid1").shieldGrid({
            ...
            columns: [                
                { field: "Nombre", width: "150px", title: "Nombre" },
                { field: "NombreLegal",  title: "NombreLegal" },
                { field: "ConsumidorFinal", title: "ConsumidorFinal" },
                { field: "CreditoFiscal", title: "CreditoFiscal" },
