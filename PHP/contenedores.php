...
if (S_iniciado() && _F_usuario_cache('nivel') == 'agencia') {
    ...
    $menu[] = array('url' => PROY_URL . 'contenedores.html', 'modo' => 'ingreso', 'titulo' => 'RECEPCION');
     $menu[] = array('url' => PROY_URL . 'contenedores.html', 'modo' => 'ingresoTaller', 'titulo' => 'RECEPCION TALLER');
    ...
    <tbody>
        <tr>
            <td style="width:330px;vertical-align:top;">
                ...
                switch ($_GET['modo']) {
                    case 'ingreso':
                        ...
                        break;
                    case 'ingresoTaller':
                        require_once('PHP/contenedores.ingresoTaller.php');
                        break;    
                    case 'remociones':
            ...
            <td id="opsal_mapa" style="width:755px;background-color:white;text-align:left;vertical-align: top;">
                ...
                <hr />
                <table id="opsal_regla_superior" style="width:741px;height:10px;left: 14px;position: relative;">
                    <tr>
                        <?php
                ...
                <table id="opsal_regla_lateral" style="float:left;width:13px;">
                    <?php
                ...
                <div style="clear: both; position: relative;bottom: 0px;">
                    <table style="table-layout: fixed;" class="opsal_tabla_ancha tabla-centrada tabla-estandar">
                        <tr>
                         <td style="width:30%">OFICINA</td>
            <td style="width:70%">ENTRADA / SALIDA</td></tr>
                    </table>
                    <hr />
                    <table style="margin: auto;">
                        <tr>
                            ...
                            <td rel="5" class="limitar_nivel contenedor_mapa_casilla_estiba_6">&nbsp;</td>
                        </tr>
                        <tr>
                            <td>Nivel 1</td>
                            <td>Nivel 2</td>
