...
if (mysqli_num_rows($r) > 0)
{
    ...
    {
        $agencia .= sprintf('<tr><td>%s</td><td>%s</td></tr>',$registro['usuario'],'<a href="/myr/administracion.html?modo=agencias&submodo=editar&objetivo='.$registro['codigo_usuario'].'">Modificar</a> | <a href="/myr/administracion.html?modo=agencias&submodo=eliminar&objetivo='.$registro['codigo_usuario'].'">Eliminar</a>');
    }
}
$agencia .= '</tbody>';
$agencia .= '<thead>';
